  ...
  return (
    <Card className="w-full max-w-md bg-[var(--card)] border-[var(--accent)] shadow-lg">
      <CardHeader className="bg-[var(--secondary)] border-b border-[var(--accent)]">
        <h1 className="text-2xl font-bold text-center text-[var(--foreground)]">Welcome Back</h1>
        <p className="text-[var(--muted-foreground)] text-center">Sign in to your account</p>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full border-[var(--border)] hover:bg-[var(--secondary)]"
          ...
          <p className="text-center text-sm text-[var(--muted-foreground)]">
            ...
            <Link href="/register" className="text-[var(--primary)] hover:underline font-medium focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 rounded">
              Sign up
            </Link>
          </p>
        </form>
